...
function expandNode(node, original) {
    ...
    if (node === null || node === void 0 ? void 0 : node.typeAnnotation) {
        str +=
            ': ' +
                original.slice(node.typeAnnotation.typeAnnotation.start, node.typeAnnotation.typeAnnotation.end);
    }
    return str;
}
    ...
    const printJsExpression = () => {
        ...
        return parent.expression
            ? printJS$1(parent, 'expression', {
                forceSingleQuote: (_a = (options.svelteStrictMode && !options._svelte_is5Plus)) !== null && _a !== void 0 ? _a : false,
            })
            : undefined;
    };
    ...
    switch (parent.type) {
        ...
        case 'SnippetBlock':
            ...
            if (node === parent.expression) {
                parent.expression.end =
                    options.originalText.indexOf(')', (_g = (_d = (_c = (_b = (_a = parent.parameters) === null || _a === void 0 ? void 0 : _a[parent.parameters.length - 1]) === null || _b === void 0 ? void 0 : _b.typeAnnotation) === null || _c === void 0 ? void 0 : _c.end) !== null && _d !== void 0 ? _d : (_f = (_e = parent.parameters) === null || _e === void 0 ? void 0 : _e[parent.parameters.length - 1]) === null || _f === void 0 ? void 0 : _f.end) !== null && _g !== void 0 ? _g : parent.expression.end) + 1;
        ...
        case 'Element':
            printJS$1(parent, 'tag', {
                forceSingleQuote: (_h = (options.svelteStrictMode && !options._svelte_is5Plus)) !== null && _h !== void 0 ? _h : false,
            });
            break;
        case 'MustacheTag':
            printJS$1(parent, 'expression', {
        ...
        case 'ConstTag':
            ...
            break;
        case 'Binding':
            printJS$1(parent, 'expression', { removeParentheses: true, surroundWithSoftline: true });
            break;
        case 'RenderTag':
            if (node === parent.expression) {
                ...
                if ('argument' in parent || 'arguments' in parent) {
                    parent.expression.end =
                        options.originalText.indexOf(')', (_o = (_k = (_j = parent.argument) === null || _j === void 0 ? void 0 : _j.end) !== null && _k !== void 0 ? _k : (_m = (_l = parent.arguments) === null || _l === void 0 ? void 0 : _l[parent.arguments.length - 1]) === null || _m === void 0 ? void 0 : _m.end) !== null && _o !== void 0 ? _o : parent.expression.end) + 1;
        ...
        return (textToDoc) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (node.surroundWithSoftline) {
                    docs = group$1(indent$1([softline$1, group$1(docs), dedent$1(softline$1)]));
                }
                return docs;
            }
            catch (e) {
...
const typescriptParser = dn['babel-ts']; // TODO use TypeScript parser in next major?
        ...
        parse: (text, options) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                if (options.svelte5CompilerPath) {
                    try {
                        _parse = (yield Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(options.svelte5CompilerPath)); })).parse;
                    }
                    catch (e) {
                ...
                return Object.assign(Object.assign({}, _parse(text)), { __isRoot: true });
            }
            catch (err) {
