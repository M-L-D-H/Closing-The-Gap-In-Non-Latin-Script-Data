...
export declare function parseLegend(model: Model): Partial<Record<"fill" | "stroke" | "angle" | "time" | "color" | "fillOpacity" | "opacity" | "strokeOpacity" | "strokeWidth" | "size" | "strokeDash" | "shape", LegendComponent>>;
